          ...
          <div className="container mx-auto px-6 flex relative pt-44 pb-12">
            <div className="sm:w-2/3 md:w-4/5 flex flex-col relative z-20">
              ...
              <p className="pt-10 text-sm sm:text-2xl text-white">
                Synx is a team of expert players with the mission of supporting
                companies to desing, launch and scale their AI, Machine Learning
        ...
        <div className="flex relative items-center">
          <div className="container mx-auto px-6 flex relative py-8">
            ...
            <div className="sm:w-full md:w-2/6 flex flex-col relative z-20">
              <p className="pt-10 text-sm sm:text-2xl text-white">
                Founded in 2016, Synx has been helping industry leaders,
                enterprises and organizations to sucessfully launch and run
                Machine Learning projects, saving them time and resources.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-6 flex relative py-8">
            ...
            <div className="sm:w-full md:w-2/5 flex flex-col relative z-20">
              <p className="pt-10 text-sm sm:text-2xl text-white">
                ...
                journey to make the tools that will make the future posible.
              </p>
              <p className="pt-10 text-sm sm:text-2xl text-white">
                Our platforms, tools and methodologies are built by
                infrastructure data engineers and scientists with the enterprise
                in mind.
              </p>
            </div>
          </div>
        ...
        <div className="flex relative z-20 items-center overflow-hidden">
          <div className="container mx-auto px-6 flex relative pt-24 pb-6">
            <div className="sm:w-2/3 md:w-4/5 flex flex-col relative z-20">
              ...
              <p className="pt-10 text-sm sm:text-2xl text-white">
                From scoping and design, to development, model training,
                integration and DevOps. We deliver a complete end-to-end
                solutions for companies business analytics and data problems.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex relative items-center">
          <div className="container mx-auto px-6 flex relative pt-20 pb-6">
            <div className="sm:w-2/3 md:w-4/5 flex flex-col relative z-20">
              ...
              <p className="pt-10 text-sm sm:text-2xl text-white">
                Synx is a venture capital backed company. We are in great
                company of leading investors in High Tech, Infraestructure,
                Artificial Intelligence and Enterprise Platforms.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="container mx-auto px-6 flex relative pt-8">
            <div className="sm:w-full md:w-1/4 flex flex-col relative z-20">
              ...
              >
                <RatioImage
                  ratio={(233 / 310) * 100}
                  alt="ID345"
                  className="synx-border-gradient opacity-50 hover:opacity-100 transition-all duration-500"
                  src="/assets/investors/id345.svg"
                />
              </a>
            </div>
            <div className="sm:w-full md:w-1/4 flex flex-col relative z-20 pt-24">
              ...
              >
                <RatioImage
                  ratio={(233 / 310) * 100}
                  alt="Genesis Capital Ventures"
                  className="synx-border-gradient opacity-50 hover:opacity-100 transition-all duration-500"
                  src="/assets/investors/genesis-capital.svg"
                />
              </a>
            </div>
            <div className="sm:w-full md:w-1/4 flex flex-col relative z-20">
              ...
              >
                <RatioImage
                  ratio={(233 / 310) * 100}
                  alt="Hackers &amp; Founders"
                  className="synx-border-gradient opacity-50 hover:opacity-100 transition-all duration-500"
                  src="/assets/investors/hf.svg"
                />
              </a>
            </div>
          </div>
            ...
            <div className="sm:w-full md:w-1/4 flex flex-col relative z-20 pt-24">
              ...
              >
                <RatioImage
                  ...
                  alt="BlueBox"
                  className="synx-border-gradient opacity-50 hover:opacity-100 transition-all duration-500"
                  src="/assets/investors/bluebox.svg"
                />
              </a>
            </div>
            <div className="sm:w-full md:w-1/4 flex flex-col relative z-20">
              <a
                className="p-2"
                href="https://www.angelventures.vc/avnetwork"
                target="_blank"
                rel="noreferrer"
              >
                <RatioImage
                  ...
                  alt="AVM"
                  className="synx-border-gradient opacity-50 hover:opacity-100 transition-all duration-500"
                  src="/assets/investors/angel-ventures.svg"
                />
              </a>
            </div>
          </div>
